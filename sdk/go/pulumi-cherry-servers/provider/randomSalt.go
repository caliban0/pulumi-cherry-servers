...
func NewRandomSalt(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("pulumi-cherry-servers:provider:RandomSalt", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetRandomSalt(ctx *pulumi.Context,
	...
	var resource RandomSalt
	err := ctx.ReadResource("pulumi-cherry-servers:provider:RandomSalt", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
